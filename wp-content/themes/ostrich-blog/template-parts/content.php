...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> class="<?php echo esc_attr($classes); ?>">
	...
	?>
		...
		<?php
			$archive_date_enable = get_theme_mod( 'ostrich_blog_enable_archive_date', true );
			$archive_category_enable = get_theme_mod( 'ostrich_blog_enable_archive_cat', true );
		?>
	        ...
	        <div class="entry-content">
	            <?php
					$archive_content_type = get_theme_mod( 'ostrich_blog_enable_archive_content_type', 'excerpt' );
